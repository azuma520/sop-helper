 ...
 * 驗證 PDCA 期間是否有效
 */
export declare function validatePDCAPeriod(periodStart: Date, periodEnd: Date): boolean;
/**
 * 驗證 PDCA 狀態轉換是否合法
 */
export declare function canTransitionStatus(currentStatus: PDCAStatus, targetStatus: PDCAStatus): boolean;
/**
 * 驗證 PDCA 是否可以提交審核
 */
export declare function canSubmitForReview(pdca: Partial<PDCA>): {
    valid: boolean;
